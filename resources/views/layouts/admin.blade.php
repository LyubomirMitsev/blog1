...
<head>
  ...
  <script src="{{ asset('js/admin-lte/adminlte.min.js') }}" defer></script>
  <script src="{{ asset('js/admin-lte/adminlte.min.js.map') }}" defer></script>

  <!-- Styles -->
  <link href="{{ asset('css/app.css') }}" rel="stylesheet">
  <link href="{{ asset('css/admin-lte/adminlte.min.css') }}" rel="stylesheet">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/bower_components/admin-lte/index3.html" class="brand-link">
      <img src="{{ asset('img/admin-lte/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
